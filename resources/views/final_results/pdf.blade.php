...
<head>
    <style>
        ...
        .profile-photo {
            ...
            right: 50;
            top: 18px;
            /* Adjusted the top position to move the photo down */
            width: 100px;
        }
...
<body>
    ...
    @foreach($students as $student)
        <div class="container">
            ...
            <div class="details">
                <p>This is to certify that {{ $student->first_name }} {{ $student->middle_name }} {{ $student->last_name }}
                    whose details are specified in the table below attained the grades against respective modules shown in
                    the table for Examination results.</p>
            ...
            <div class="bottom-container" style="padding-left: 9%;">
                <div class="col text-left">
                    ...
                    <img style="height:28px; position: relative; width:100px; z-index:1;"
                        src="{{ url('resources/assets/images/signatures/chief_instructor.png') }}" alt="signature"></br>
                    <span style="margin-top: -100px; font-size:18px">Chief Instructor</span>
                </div>
                <div class="col text-right date-issue">
                    <p style="border-bottom: 2px dotted #000; display: inline-block; padding-bottom: 2px;">
                        {{ now()->toDateString() }}</p>
                    <p style=" font-size:18px">Date of Issue</p>
                </div>
                <div class="" style="text-align: center;margin-top: -79px; ">
                    <img src="{{ url('resources/assets/images/award.png') }}" alt="award" class="award" style="width:70px;">
                </div>
                <div class="qr-code" style="text-align: left; margin-left: 5px; margin-top: -20px;">
                    <img src="{{ $student->qrCodeBase64 }}" style="width: 72px;" alt="QR Code">
                </div>

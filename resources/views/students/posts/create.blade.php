...
@section('content')
    ...
    <div class="mt-3">
        <p>&nbspPlease download the sample uploading excel file and review your students posts list before submitting. If you
            encounter any issues, feel free to contact support.</p>
    </div>

    <form method="POST" action="{{route('students-post.bulkimport')}}" style="display:inline" enctype="multipart/form-data"
            style="float:right;">
            @csrf
            @method('POST')

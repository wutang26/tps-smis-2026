                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        @foreach ($kins as $kin)
                                                                                            ...
                                                                                            <td>
                                                                                                ...
                                                                                                <input type="text"   value="{{ $kin['name'] }}" name="next_of_kin[{{ $loop->index }}][name]" class="form-control form-control-sm editable-field d-none">
                                                                                            </td>

                                                                                            <td>
                                                                                                <span class="static-field">{{ $kin['relationship'] }}</span>
                                                                                                <input type="text" value="{{ $kin['relationship'] }}" name="next_of_kin[{{ $loop->index }}][relationship]" class="form-control form-control-sm editable-field d-none">
                                                                                            </td>

                                                                                            <td>
                                                                                                <span class="static-field">{{ $kin['phone'] }}</span>
                                                                                                <input type="text" value="{{ $kin['phone'] }}" name="next_of_kin[{{ $loop->index }}][phone]" class="form-control form-control-sm editable-field d-none">
                                                                                            </td>

                                                                                            <td>
                                                                                                <span class="static-field">{{ $kin['address'] }}</span>
                                                                                                <input type="text" value="{{ $kin['address'] }}" name="next_of_kin[{{ $loop->index }}][address]" class="form-control form-control-sm editable-field d-none">
                                                                                            </td>
                                                                                            </tr>
                                                                                        @endforeach

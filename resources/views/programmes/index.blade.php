  ...
  <div class="container-fluid">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a href="#">Programme Lists</a></li>
      </ol>
    </nav>
  </div>
</nav>
  ...
  <div class="col-sm-12">
    <div class="card mb-3">
      ...
      <div class="pull-right" >
          ...
          <a class="btn btn-success mb-2" href="{{ route('programmes.create') }}" style="float:right !important; margin-right:1%"><i class="fa fa-plus"></i> Create New Programme</a>
      </div>
      <div class="card-body">
            ...
            <table class="table table-striped truncate m-0">
              ...
              @foreach ($programmes as $key => $prog)
                <tr>
                    ...
                    <td>
                        <a class="btn btn-info btn-sm" href="{{ route('programmes.show',$prog->id) }}"><i class="fa-solid fa-list"></i> Show</a>
                        <a class="btn btn-primary btn-sm" href="{{ route('programmes.edit',$prog->id) }}"><i class="fa-solid fa-pen-to-square"></i> Edit</a>

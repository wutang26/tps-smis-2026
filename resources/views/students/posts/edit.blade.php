        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('students-post.index') }}}}">Posts</a></li>
...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        <a href="{{ route('students-post.downloadSample') }}"><button style="height: 30px;" class="btn btn-sm btn-success"><i
                    class="bi bi-download"></i>&nbsp&nbspDownload sample for Updating posts</button></a>
    </div>
    <div class="mt-3">
        <p>&nbspPlease download the sample updating excel file and review your students posts list before submitting. If you
            encounter any issues, feel free to contact support.</p>
    </div>

    <form method="POST" action="{{route('students-post-update.bulkimport')}}" style="display:inline" enctype="multipart/form-data"
            style="float:right;">
            @csrf
            @method('POST')

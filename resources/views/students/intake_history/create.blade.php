  ...
  <div class="container-fluid">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a href="#">Add Termination Reason</a></li>
      </ol>
    </nav>
  </div>
</nav>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-left">
                            <h2>Add New Reason for Termination</h2>
                        </div>
                ...
                @endif
            <form method="POST" action="{{ route('termination_reasons.store') }}">
                @csrf
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Reason for Termination:</strong>
                            <input type="text" name="reason" placeholder="Enter reason name" class="form-control">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">

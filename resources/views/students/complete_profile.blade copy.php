                                          ...
                                          <!-- <label class="form-label" for="abt">About </label> -->
                                            ...
                                            <div id="next-of-kin-container">
                                                ...
                                                @if ($student->next_of_kin)
                                                    @foreach ($student->next_of_kin as $index => $nextOfKin)
                                                      <div class="form-control next-of-kin">
                                                        ...
                                                        <div class="row gx-4">
                                                            ...
                                                            <button type="button"  class="form-control" onclick="removeNextOfKin(this)">Remove</button>
                                                        </div>
                                                    @endforeach
                                                @endif
                                            </div>
                            ...
                            <div class="col-sm-3 col-12">
                              <div class="card border mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <img id="photo-preview" src="{{ $student->photo ? Storage::url($student->photo) : '' }}" alt="Photo Preview" width="150" height="150">
                                    </div>
                                </div>
                              </div>
                            </div>
